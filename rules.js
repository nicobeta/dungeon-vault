var rules = {
    ...
    weapons: [
        {id: 'shortsword', name: 'Shortsword', damage: '1d6', type: 'melee', twoHands: false},
        {id: 'longsword', name: 'Longsword', damage: '1d8', type: 'melee', twoHands: true},
        {id: 'greatsword', name: 'Greatsword', damage: '2d6', type: 'melee', twoHands: true},
        {id: 'shortbow', name: 'Shortbow', damage: '1d6', type: 'ranged'},
        {id: 'longbow', name: 'Longbow', damage: '1d8', type: 'ranged'},
        {id: 'hand-crossbow', name: 'Hand crossbow', damage: '1d4', type: 'ranged'},
        {id: 'light-crossbow', name: 'Light crossbow', damage: '1d8', type: 'ranged'},
        {id: 'heavy-crossbow', name: 'Heavy crossbow', damage: '1d10', type: 'ranged'},
        {id: 'repeating-heavy-crossbow', name: 'Repeating heavy crossbow', damage: '1d10', type: 'ranged'},
        {id: 'repeating-light-crossbow', name: 'Repeating light crossbow', damage: '1d8', type: 'ranged'},
        {id: 'javelin', name: 'Javelin', damage: '1d6', type: 'ranged'},
        {id: 'dart', name: 'Dart', damage: '1d4', type: 'ranged'},
        {id: 'sling', name: 'Sling', damage: '1d4', type: 'ranged'}
    ],
    damageIncrement: [
